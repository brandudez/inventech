...
/* =========================
   SEARCH + FILTERS
   (division is implicit — never from URL)
========================= */
...
/* =========================
   WHERE BUILDER
   (division_id always locked to encoder's division)
========================= */
$where  = ["f.division_id = ?"];
...
if ($acq_filter === 'lt5') {
    ...
    $where[] = "(f.acquisition_date IS NULL OR f.acquisition_date = '0000-00-00' OR f.acquisition_date = '')";
}
...
// Stat-box counts: layer active/inactive on top of current filters
$activeWhere   = $where;
...
// Export query string — no division param (implicit server-side)
                    ...
                    <form action="add_firewall.php" method="POST">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <!-- Hidden field sends the value; visible input is purely decorative -->
        ...
        <div class="table-container">
            <table class="users-table">
                ...
                <tbody>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="view-label">No of Ports</div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="view-label">Firmware Version</div>
                                                    <div class="view-value"><?= htmlspecialchars($row['firmware_version'] ?? '') ?></div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="view-label">Management Interface</div>
                                                    <div class="view-value"><?= htmlspecialchars($row['management_interface_type'] ?? '') ?></div>
                                                </div>
                                                <div class="col-md-4">
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="21" class="text-center">No firewall devices found.</td>
                        </tr>
                    <?php endif; ?>
