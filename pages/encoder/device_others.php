...
if ($acq_filter === 'lt5') {
    ...
    $where[] = "(o.acquisition_date IS NULL OR o.acquisition_date = '0000-00-00' OR o.acquisition_date = '')";
}
...
$activeWhere   = array_merge($where, ["o.is_active = 1"]);
$activeSQL     = "WHERE " . implode(" AND ", $activeWhere);
$inactiveWhere = array_merge($where, ["o.is_active = 0"]);
...
<body>
    ...
    <div class="top-bar">
        <div class="search-container">
            <form method="GET" action="device_others.php" class="search-form">
