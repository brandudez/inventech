...
if ($acq_filter === 'lt5') {
    ...
    $where[] = "(p.acquisition_date IS NULL OR p.acquisition_date = '0000-00-00' OR p.acquisition_date = '')";
}
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="add_printer.php" method="POST" id="addPrinterForm">
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                            <button type="button" class="btn btn-primary" data-bs-dismiss="modal" data-edit-target="#editPrModal<?= $row['id'] ?>">
