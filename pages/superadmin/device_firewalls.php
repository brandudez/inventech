...
$aw = $where; $aw[] = "f.is_active = 1"; $aSQL = "WHERE " . implode(" AND ", $aw);
...
$iw = $where; $iw[] = "f.is_active = 0"; $iSQL = "WHERE " . implode(" AND ", $iw);
                ...
                <div class="modal-body">
                    <form method="POST" action="add_firewall.php" id="addFirewallForm">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6"><label class="form-label">Serial No</label><input type="text" class="form-control" name="serial_no" required></div>
                            <div class="col-md-3"><label class="form-label">No of Ports</label><input type="number" class="form-control" name="no_of_ports" min="0" required></div>
                            <div class="col-md-3"><label class="form-label">Active Ports</label><input type="number" class="form-control" name="no_of_active_ports" min="0" required></div>
                            <div class="col-md-6"><label class="form-label">Firmware Version</label><input type="text" class="form-control" name="firmware_version" required></div>
                            <div class="col-md-6"><label class="form-label">Management Interface Type</label><input type="text" class="form-control" name="management_interface_type" required></div>
                            ...
                            <div class="col-md-4"><label class="form-label">Acquisition Type</label><input type="text" class="form-control" name="acquisition_type"></div>
                            <div class="col-md-12"><label class="form-label">Acquisition Details</label><input type="text" class="form-control" name="acquisition_details"></div>
                            <div class="col-md-12"><label class="form-label">Remarks</label><textarea class="form-control" name="remarks"></textarea></div>
                            <div class="col-md-12">
        ...
        <div class="table-container">
            <table class="users-table">
                ...
                <tbody>
                    ...
                    <?php if ($result->num_rows > 0): ?>
                        <?php while ($row = $result->fetch_assoc()): ?>
                            ...
                            <tr class="clickable-row" data-active="<?= $row['is_active'] ? '1' : '0' ?>"
                                ...
                                <td><?= $row['is_remotely_accessible'] ? '<span class="text-success fw-bold">YES</span>' : '<span class="text-danger fw-bold">NO</span>' ?></td>
                            ...
                            <div class="modal fade" id="viewFirewallModal<?= $row['id'] ?>" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-xl modal-dialog-scrollable modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header text-white" style="background-color:#0d6ea8;">
                                            <h5 class="modal-title"><i class="bi bi-shield-lock me-2"></i>Firewall Details — <?= htmlspecialchars(trim(($row['manufacturer'] ?? '') . ' ' . ($row['model'] ?? ''))) ?></h5>
                                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                                        </div>
                                        <div class="modal-body">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-4"><div class="view-label">Is Remotely Accessible?</div><div class="view-value"><?= $row['is_remotely_accessible'] ? '<span class="text-success fw-bold">YES</span>' : '<span class="text-danger fw-bold">NO</span>' ?></div></div>
                                                <div class="col-md-4"><div class="view-label">Remote Connection Details</div><div class="view-value"><?= htmlspecialchars($row['remote_connection_details'] ?? 'N/A') ?></div></div>
                                                <div class="col-md-4"><div class="view-label">PNP Focal Person</div><div class="view-value"><?= htmlspecialchars($row['pnp_focal_person'] ?? 'N/A') ?></div></div>
                                                <div class="col-md-4"><div class="view-label">Contact Details</div><div class="view-value"><?= htmlspecialchars($row['contact_details'] ?? 'N/A') ?></div></div>
                                                ...
                                                <div class="col-md-4"><div class="view-label">Created Date</div><div class="view-value"><?= htmlspecialchars($row['created_date'] ?? 'N/A') ?></div></div>
                                                <div class="col-md-12"><div class="view-label">Acquisition Details</div><div class="view-value"><?= htmlspecialchars($row['acquisition_details'] ?? 'N/A') ?></div></div>
                                                <div class="col-md-12"><div class="view-label">Remarks</div><div class="view-value"><?= htmlspecialchars($row['remarks'] ?? 'N/A') ?></div></div>
                                ...
                                <div class="modal-dialog modal-xl modal-dialog-scrollable modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header" style="background-color:#0d6ea8;">
                                            <h5 class="modal-title text-white">Edit Firewall</h5>
                                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                                        </div>
                                        <div class="modal-body">
                                            <form method="POST" action="edit_firewall.php">
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-6"><label class="form-label">Serial No</label><input type="text" class="form-control" name="serial_no" value="<?= htmlspecialchars($row['serial_no'] ?? '') ?>" required></div>
                                                    <div class="col-md-3"><label class="form-label">No of Ports</label><input type="number" class="form-control" name="no_of_ports" min="0" value="<?= htmlspecialchars($row['no_of_ports'] ?? '') ?>" required></div>
                                                    <div class="col-md-3"><label class="form-label">Active Ports</label><input type="number" class="form-control" name="no_of_active_ports" min="0" value="<?= htmlspecialchars($row['no_of_active_ports'] ?? '') ?>" required></div>
                                                    <div class="col-md-6"><label class="form-label">Firmware Version</label><input type="text" class="form-control" name="firmware_version" value="<?= htmlspecialchars($row['firmware_version'] ?? '') ?>" required></div>
                                                    <div class="col-md-6"><label class="form-label">Management Interface Type</label><input type="text" class="form-control" name="management_interface_type" value="<?= htmlspecialchars($row['management_interface_type'] ?? '') ?>" required></div>
                                                    <div class="col-md-6"><label class="form-label">Location</label><input type="text" class="form-control" name="location" value="<?= htmlspecialchars($row['location'] ?? '') ?>" required></div>
                                                    <div class="col-md-3">
                                                        <label class="form-label">Is Active?</label>
                                                    ...
                                                    <div class="col-md-4"><label class="form-label">Acquisition Type</label><input type="text" class="form-control" name="acquisition_type" value="<?= htmlspecialchars($row['acquisition_type'] ?? '') ?>"></div>
                                                    <div class="col-md-12"><label class="form-label">Acquisition Details</label><input type="text" class="form-control" name="acquisition_details" value="<?= htmlspecialchars($row['acquisition_details'] ?? '') ?>"></div>
                                                    <div class="col-md-12"><label class="form-label">Remarks</label><textarea class="form-control" name="remarks"><?= htmlspecialchars($row['remarks'] ?? '') ?></textarea></div>
                                                    <div class="col-md-12">
                                                        <label class="form-label">Previous Handler/s</label>
                                                        <div class="dropdown w-100">
                                                            <button class="form-select text-start" type="button" data-bs-toggle="dropdown">Select Previous Handler/s</button>
                    ...
                    <?php else: ?>
                        <tr><td colspan="22" class="text-center">No firewall devices found.</td></tr>
                    <?php endif; ?>
