    ...
    <div class="top-bar">
        ...
        <div class="search-container">
            <form method="GET" action="device_switches.php" class="search-form">
                ...
                <!-- EXPORT BUTTON -->
                <a href="export_switches.php?<?= htmlspecialchars($exportParams) ?>" class="btn add-laptop-btn" title="Export current filtered data to Excel">
                ...
                <tbody>
                    ...
                    <?php if ($result->num_rows > 0): ?>
                        <?php while ($row = $result->fetch_assoc()): ?>
                            ...
                            <!-- VIEW MODAL -->
                            <div class="modal fade" id="viewSwitchModal<?= $row['id'] ?>" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-xl modal-dialog-scrollable modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header text-white" style="background-color:#0d6ea8;">
                                            <h5 class="modal-title"><i class="bi bi-hdd-network me-2"></i>Switch Details — <?= htmlspecialchars(($row['manufacturer'] ?? '') . ' ' . ($row['model'] ?? '')) ?></h5>
                                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                                        </div>
                                        <div class="modal-body">
                                            <div class="row g-3">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                            <button type="button" class="btn btn-primary" data-bs-dismiss="modal" data-edit-target="#editSwitchModal<?= $row['id'] ?>">
                                        ...
                                        <div class="modal-body">
                                            <form action="edit_switches.php" method="POST">
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-6"><label class="form-label"># Managed Ports</label><input type="number" class="form-control" name="no_of_managed" min="0" value="<?= htmlspecialchars($row['no_of_managed'] ?? '') ?>"></div>
                                                    <div class="col-md-6"><label class="form-label"># Unmanaged Ports</label><input type="number" class="form-control" name="no_of_unmanaged" min="0" value="<?= htmlspecialchars($row['no_of_unmanaged'] ?? '') ?>"></div>
