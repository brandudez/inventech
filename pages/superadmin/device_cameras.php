    ...
    <div class="top-bar">
        <div class="search-container">
            <form class="search-form" method="GET" action="device_cameras.php">
                ...
                <!-- EXPORT BUTTON -->
                <a href="export_cameras.php?<?= htmlspecialchars($exportParams) ?>" class="btn add-laptop-btn" title="Export current filtered data to Excel">
    ...
    <script>
        ...
        <?php if (isset($_GET['edit'])): ?>
            document.addEventListener("DOMContentLoaded", function() {
                let modal = document.getElementById("editCamModal<?= (int)$_GET['edit'] ?>");
