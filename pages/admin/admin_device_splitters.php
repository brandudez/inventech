...
<!-- NAVBAR -->
    ...
    <div class="top-bar">
        ...
        <div class="search-container">
            <form method="GET" action="device_splitter.php" class="search-form">
                ...
                <!-- EXPORT BUTTON -->
              <a href="export_splitter.php?<?= htmlspecialchars($exportParams) ?>"
   ...
   onclick="setTimeout(()=>showToast('Export downloaded successfully!','success'),800)">
    <i class="bi bi-file-earmark-excel-fill"></i> Export as Excel
        ...
        <div class="right-side">
            ...
            <div class="filters">
                <form method="GET" action="device_splitter.php" id="filterForm">
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="add_splitter.php" method="POST">
                        <div class="row g-3">
                            <div class="col-md-4">
        ...
        <div class="table-container">
            <table class="users-table">
                ...
                <tbody>
                        ...
                        <?php while ($row = $result->fetch_assoc()): ?>
                            ...
                            <div class="modal fade" id="viewSplitterModal<?= $row['id'] ?>" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-xl modal-dialog-scrollable modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header text-white" style="background-color:#0d6ea8;">
                                            <h5 class="modal-title"><i class="bi bi-shield-lock me-2"></i>Splitter Details — <?= htmlspecialchars(($row['manufacturer'] ?? '') . ' ' . ($row['model'] ?? '')) ?></h5>
                                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                                        </div>
                                        <div class="modal-body">
                                            <div class="row g-3">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                            <button type="button" class="btn btn-primary" data-bs-dismiss="modal" data-edit-target="#editSplitterModal<?= $row['id'] ?>">
                            ...
                            <div class="modal fade" id="editSplitterModal<?= $row['id'] ?>" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-xl modal-dialog-scrollable modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="edit_splitter.php" method="POST">
                    ...
                    <?php else: ?>
                        <tr><td colspan="21" class="text-center">No Splitter devices found.</td></tr>
                    <?php endif; ?>
