...
<body>
    ...
    <div class="top-bar">
        ...
        <div class="search-container">
            <form method="GET" action="admin_device_routers.php" class="search-form">
                ...
                <!-- EXPORT BUTTON -->
                <a href="admin_export_routers.php?<?= htmlspecialchars($exportParams) ?>"
        ...
        <div class="right-side">
            ...
            <div class="filters">
                <form method="GET" action="admin_device_routers.php" id="filterForm">
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="admin_add_routers.php" method="POST">
                        <div class="row g-3">
                            <div class="col-md-4">
                            ...
                            <div class="modal fade" id="editRouterModal<?= $row['id'] ?>" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-xl modal-dialog-scrollable modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="admin_edit_router.php" method="POST">
