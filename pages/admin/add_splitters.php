...
if (!isset($_POST['save_splitter'])) {
    header("Location: admin_device_splitters.php");
    exit();
}
...
if ($stmt->execute()) {
    $_SESSION['toast_success'] = "Splitter added successfully!";
    header("Location: admin_device_splitters.php");
    exit();
} else {
    $_SESSION['toast_error'] = "Error adding splitter: " . $stmt->error;
    header("Location: admin_device_splitters.php");
    exit();
}
