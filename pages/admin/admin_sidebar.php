...
<div class="sidebar" id="sidebar">
    ...
    <a href="admin_user_create.php"
        class="<?= basename($_SERVER['PHP_SELF']) == 'admin_user_create.php' ? 'active' : '' ?>">
        <span class="icon"><i class="bi bi-people"></i></span>
        <span class="text">Add User</span>
    </a>

    <a href="admin_users_list.php"
        class="<?= basename($_SERVER['PHP_SELF']) == 'admin_users_list.php' ? 'active' : '' ?>">
        <span class="icon"><i class="bi bi-person-plus"></i></span>
        <span class="text">Users List</span>
    </a>

    <a href="admin_personnel_list.php"
        class="<?= basename($_SERVER['PHP_SELF']) == 'admin_personnel_list.php' ? 'active' : '' ?>">
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-content" id="deviceDropdown">
            ...
            class="<?= basename($_SERVER['PHP_SELF']) == 'admin_device_desktops.php' ? 'active' : '' ?>">
                <div class="menu-item">
            ...
            <a href="admin_device_laptops.php"
                class="<?= basename($_SERVER['PHP_SELF']) == 'admin_device_laptops.php' ? 'active' : '' ?>">
                <div class="menu-item">
            ...
            <a href="admin_device_printers.php"
                class="<?= basename($_SERVER['PHP_SELF']) == 'admin_device_printers.php' ? 'active' : '' ?>">
                <div class="menu-item">
            ...
            <a href="admin_device_cameras.php"
                class="<?= basename($_SERVER['PHP_SELF']) == 'admin_device_cameras.php' ? 'active' : '' ?>">
                <div class="menu-item">
            ...
            <a href="admin_device_headsets.php"
                class="<?= basename($_SERVER['PHP_SELF']) == 'admin_device_headsets.php' ? 'active' : '' ?>">
                <div class="menu-item">
            ...
            <a href="admin_device_switches.php"
                class="<?= basename($_SERVER['PHP_SELF']) == 'admin_device_switches.php' ? 'active' : '' ?>">
                <div class="menu-item">
            ...
            <a href="admin_device_routers.php"
                class="<?= basename($_SERVER['PHP_SELF']) == 'admin_device_routers.php' ? 'active' : '' ?>">
                <div class="menu-item">
            ...
            <a href="admin_device_firewalls.php"
                class="<?= basename($_SERVER['PHP_SELF']) == 'admin_device_firewalls.php' ? 'active' : '' ?>">
                <div class="menu-item">
