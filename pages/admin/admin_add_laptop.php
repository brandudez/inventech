...
$os_license_key             = nullIfEmpty($_POST['os_license_key']             ?? '');   // ++ NEW
...
$office_license_key         = nullIfEmpty($_POST['office_license_key']         ?? '');   // ++ NEW
...
// 31 columns (original 29 + os_license_key + office_license_key)
...
$stmt->bind_param(
    ...
    $os,                        // 6
    $is_os_licensed,            // 7
    $os_license_key,            // 8  ++ NEW
    $is_remote_acc,             // 9
    $endpoint_security_json,    // 10
    $no_of_installed_anti_virus, // 11
    $date_installed,            // 12
    $guid,                      // 13
    $mac_address,               // 14
    $cpu_brand,                 // 15
    ...
    $gb_ram,                    // 18
    $monitor_brand,             // 19
    $monitor_size_inches,       // 20
    $no_of_user_accounts,       // 21
    $user_account_type,         // 22
    $authorized_software,       // 23
    $unauthorized_software,     // 24
    $acquisition_date,          // 25
    $office_application,        // 26
    $is_office_licensed,        // 27
    $office_license_key,        // 28 ++ NEW
    $previous_owners_json,      // 29
    $par_serial_no,             // 30
    $is_active                  // 31
);
