...
<body>
    ...
    <div class="top-bar">
        ...
        <div class="search-container">
            <form method="GET" action="admin_device_firewalls.php" class="search-form">
                ...
                <!-- EXPORT BUTTON -->
                <a href="admin_export_firewalls.php?<?= htmlspecialchars($exportParams) ?>"
        ...
        <div class="right-side">
            ...
            <div class="filters">
                <form method="GET" action="admin_device_firewalls.php" id="filterForm">
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="admin_add_firewall.php" method="POST">
                        <div class="row g-3">
                            <div class="col-md-4">
                            ...
                            <div class="modal fade" id="editFirewallModal<?= $row['id'] ?>" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-xl modal-dialog-scrollable modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="admin_edit_firewall.php" method="POST">
