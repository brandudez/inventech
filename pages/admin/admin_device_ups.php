...
$activeWhere   = $where;
$activeWhere[] = "u.is_active = 1";
$activeSQL     = "WHERE " . implode(" AND ", $activeWhere);

$inactiveWhere   = $where;
$inactiveWhere[] = "u.is_active = 0";
...
<body>
    ...
    <div class="top-bar">
        ...
        <div class="search-container">
            <form method="GET" action="admin_device_ups.php" class="search-form">
        ...
        <div class="right-side">
            <div class="filters">
                <form method="GET" action="admin_device_ups.php" id="filterForm">
