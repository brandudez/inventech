...
if ($active_filter !== '') { $where[] = "d.is_active = ?"; $params[] = $active_filter; $types .= 'i'; }
...
$aw = $where; $aw[] = "d.is_active = 1"; $aSQL = "WHERE " . implode(" AND ", $aw);
...
$iw = $where; $iw[] = "d.is_active = 0"; $iSQL = "WHERE " . implode(" AND ", $iw);
...
<head>
    ...
    <link rel="stylesheet" href="assets/admin_desktop_laptop.css">
